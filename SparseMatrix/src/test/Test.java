...
public class Test {
	public static void main(String[] args) {
		...
		// Because we are not storing 0 values in the matrix the toString should
		// reflect an "empty" (all 0) matrix.
		System.out.println("toString is correct: " + correctString.equals(myTest.toString()));
		...
		// Note that adding 0 to the matrix overwrites the data at that position
		// to 0 as defined in the interface description
		// Because we are not storing 0 values, we can remove the element at
		// that position.
		System.out.println("toString is correct: " + correctString.equals(myTest.toString()));
		...
		SparseInterface test5 = test2.multiplyMatrices(test1); // should return
																// null
