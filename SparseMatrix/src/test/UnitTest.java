...
public class UnitTest {
	public static void main(String[] args) {
		...
		// Because we are not storing 0 values, we can remove the element at that
		// position.
		System.out.println("toString is correct: " + correctString.equals(myTest.toString()));
		...
		//System.out.println("LB 1: " + (test3 == null ? "OK" : "FAILED"));
		SparseInterface test4 = test1.multiplyMatrices(test2); // should work
		//System.out.println("LB 2: " + (test3 != null ? "OK" : "FAILED"));
		SparseInterface test5 = test2.multiplyMatrices(test1); // should return null
		//System.out.println("LB 3: " + (test3 == null ? "OK" : "FAILED"));
		
		p("test3: " + (test3 == null ? "null" : ((SparseMatrix) test3).altToString()));
		p("test4: " + (test4 == null ? "null" : ((SparseMatrix) test4).altToString()));
		p("test5: " + (test5 == null ? "null" : ((SparseMatrix) test5).altToString()));
	}
